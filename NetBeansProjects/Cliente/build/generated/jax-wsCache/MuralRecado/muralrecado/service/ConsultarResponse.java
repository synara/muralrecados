 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service.muralrecado/}recado" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ConsultarResponse {
     ...
     * 
     */
    public List<Recado> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Recado>();
        }
        return this._return;
    }
